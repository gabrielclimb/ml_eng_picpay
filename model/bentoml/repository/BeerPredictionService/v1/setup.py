...
setuptools.setup(
    name='BeerPredictionService',
    version='v1',
    description="BentoML generated model module",
    long_description="""# Generated BentoService bundle - BeerPredictionService:v1
...
""",
    ...
    package_data={
        'BeerPredictionService': ['bentoml.yml', 'artifacts/*']
    },
    entry_points={
        'console_scripts': [
            'BeerPredictionService=BeerPredictionService:cli',
        ],
    }
)
